const CtaSection = () => (
  <section className="py-24 bg-gradient-to-br from-garden-pink to-garden-pink-dark text-center relative overflow-hidden" id="adhesion">
    ...
    <div className="container relative">
      <span className="inline-flex items-center gap-1.5 bg-white/[0.18] text-white text-[0.72rem] font-bold tracking-[0.1em] uppercase px-4 py-1.5 rounded-pill mb-3.5">🌸 Membership</span>
      ...
      <div className="flex justify-center flex-wrap gap-3.5">
        <a href="mailto:contact@gardenpadel.fr?subject=Adhésion" className="inline-flex items-center gap-2 px-6 py-3 rounded-pill font-bold bg-white text-garden-blue-dark shadow-[0_6px_24px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-0.5">🌸 Devenir Membre</a>
        <a href="mailto:contact@gardenpadel.fr?subject=Partenariat" className="inline-flex items-center gap-2 px-6 py-3 rounded-pill font-bold bg-white/15 text-white border-2 border-white/35 transition-all duration-300 hover:bg-white/[0.28] hover:-translate-y-0.5">🤝 Devenir Partenaire</a>
      </div>
    </div>
  </section>
);
