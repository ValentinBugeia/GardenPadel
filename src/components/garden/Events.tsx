const Events = () => (
  <section className="py-24" id="evenements">
    <div className="container">
      <div>
        <span className="inline-flex items-center gap-1.5 bg-garden-pink-light text-garden-pink-dark text-[0.72rem] font-bold tracking-[0.1em] uppercase px-4 py-1.5 rounded-pill mb-3.5">🎉 Événements</span>
